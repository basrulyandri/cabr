        ...
        <div class="row">
          ...
          <div class="box-body">
            ...
            <div class='form-group{{$errors->has('facebook_url') ? ' has-error' : ''}}'>
                ...
                <div class="col-sm-10">
                  {!!Form::text('facebook_url',old('facebook_url'),['class' => 'form-control','placeholder' => 'Facebook URL','required' => 'true'])!!}
            ...
            <div class='form-group{{$errors->has('twitter_url') ? ' has-error' : ''}}'>
                ...
                <div class="col-sm-10">
                  {!!Form::text('twitter_url',old('twitter_url'),['class' => 'form-control','placeholder' => 'Twitter URL','required' => 'true'])!!}
            ...
            <div class='form-group{{$errors->has('google_plus_url') ? ' has-error' : ''}}'>
                ...
                <div class="col-sm-10">
                  {!!Form::text('google_plus_url',old('google_plus_url'),['class' => 'form-control','placeholder' => 'Google+ URL','required' => 'true'])!!}
